	...
	(function ($) {
	    ...
	    window.mainJS = {
	        ...
	        initTable: function initTable() {
	            (0, _jquery2.default)('.content-rules table tr:first-of-type td').each(function () {
	                var newIndex = (0, _jquery2.default)(this).index() + 1;
	                (0, _jquery2.default)(this).closest('table').find('tr:not(:first-child)').find('td:nth-child(' + newIndex + ')').attr('data-title', (0, _jquery2.default)(this).text());
	            });
	        },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function ($) {
	    ...
	    var validationRules = {
	        rulesRequared: function rulesRequared($this) {
	            return $this.prop("required");
	        },

	        rulesEmail: function rulesEmail(email) {
	            var pattern = /^([\w-\.]+)@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.)|(([\w-]+\.)+))([a-zA-Z]{2,4}|[0-9]{1,3})(\]?)$/;
	            return pattern.test(email);
	        },

	        rulesName: function rulesName(name) {
	            var pattern = /^[( )A-Za-zА-Яа-яЁё0-9_-]{3,25}$/;
	            return pattern.test(name);
	        },

	        rulesPhone: function rulesPhone(phone) {
	            var pattern = /^[( )0-9]{9,11}$/;
	            return pattern.test(phone);
	        },

	        rulesText: function rulesText(text) {
	            if (text.length <= 3) {
	                return false;
	            } else {
	                return true;
	    ...
	    var ValidateAction = {
	        change: function change($this, validate) {
